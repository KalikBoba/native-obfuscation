...
public class LdcProcessor extends BaseProcessor {
    ...
    public void translate(MethodContext context, AbstractInsnNode insnNode, MethodNode method) {
        ...
        if (cst instanceof String) {
            context.output().pushMethodLine("cstack%s.l = %s;".formatted(context.getStackPointer().peek(), ReferenceSnippetGenerator.generateStringReference(context, method, context.getConstantPool().pushUtf((cst.toString())))));
