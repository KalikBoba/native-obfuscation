package ru.kotopushka.j2c.translator.processor.instructions.impl;
...
import ru.kotopushka.j2c.translator.utils.clazz.MethodHandleUtils;
...
public class LdcPreprocessor implements InstructionProcessor {
    ...
    public void process(ClassNode classNode) {
        if (!BaseUtils.hasFlag(classNode.access, Opcodes.ACC_INTERFACE)) {
            MainJarProcessor jarProcessor = Compiler.getProcessor();
