package ru.kotopushka.j2c.translator.configuration;
...
public class TranslatorConfiguration extends YamlSerializable {
    ...
    public static class Main {
        ...
        public List<String> INCLUDES = List.of("colonialobfuscator/**");
...
//        @Comment(@CommentValue(value = " URL сайта для защиты", commentValueIndent = 1))
        public String URL_PROTECTION =  "localhost";
        @Comment(@CommentValue(value = " Пекеджи которые будет мапнуты", commentValueIndent = 1))
        public List<String> MAPPINGS = List.of("colonialobfuscator");
