...
public class MethodHandleUtils {
    ...
    public static InsnList generateMethodTypeLdcInsn(Type type, ClassNode node) {
        ...
        insntructions.add(new LdcInsnNode(Type.getObjectType(node.name)));
        insntructions.add(InsnProcessorUtils.CLASSLOADER_LOCAL.get()); // 6
    ...
    public static InsnList generateMethodHandleLdcInsn(Handle handle) {
        ...
        instructions.add(InsnProcessorUtils.LOOKUP_LOCAL.get()); // 5
        ...
        switch (handle.getTag()) {
            ...
            case Opcodes.H_INVOKEINTERFACE:
                ...
                instructions.add(InsnProcessorUtils.CLASSLOADER_LOCAL.get()); // 9
            ...
            case Opcodes.H_INVOKESPECIAL:
                ...
                instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "java/lang/invoke/MethodType",
                        "fromMethodDescriptorString", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/invoke/MethodType;")); // 8
                instructions.add(InsnProcessorUtils.CLASS_LOCAL.get()); // 9
                instructions.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, // 5
            ...
            case Opcodes.H_NEWINVOKESPECIAL:
                ...
                instructions.add(InsnProcessorUtils.CLASSLOADER_LOCAL.get()); // 8
                instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "java/lang/invoke/MethodType",
