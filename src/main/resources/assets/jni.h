...
struct JNINativeInterface_ {
    ...
    jfieldID(JNICALL* KotoPushka_GetStaticFieldID)
        (JNIEnv* env, jclass clazz, const char* name, const char* sig);
...
struct JNIEnv_ {
    ...
    jfieldID KotoPushka_GetStaticFieldID(jclass clazz, const char* name,
        const char* sig) {
        return functions->KotoPushka_GetStaticFieldID(this, clazz, name, sig);
    }
