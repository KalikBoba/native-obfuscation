...
import ru.kotopushka.j2c.translator.processor.cpp.MethodProcessor;
    ...
    public void translate(MethodContext context, AbstractInsnNode insn, MethodNode method) {
        if (insn instanceof FrameNode frameNode) {
            ...
            switch (frameType) {
                ...
                case F_CHOP:
                    frameNode.local.forEach(a -> context.getLocals().remove( context.getLocals().size() - 1));
                    stacks.clear();
                    break;
                ...
                case F_SAME1:
                    stacks.clear();
                    appendStack.accept(frameNode.stack.get(0));
                    break;
            }
