package ru.kotopushka.j2c.translator.build;


import com.google.gson.Gson;
import ru.kotopushka.j2c.translator.Compiler;
import ru.kotopushka.j2c.translator.utils.system.FileUtils;
...
//        TranslatorMain.LOGGER.error("This system is not supported. Please contact the developer");
    ...
    public static void downloadZigCompiler(final String fileName, final String dirName) {
        if (Files.exists(Paths.get(dirName))) {
            Compiler.LOGGER.info("Found compiler ({})", dirName);
            return;
        }

        try {
            final String currentDir = System.getProperty("user.dir");
            Compiler.LOGGER.info("Downloading zig compiler...");
    ...
    public static String getZigGlobalCacheDirectory(final boolean clear) {
        ...
        Compiler.LOGGER.error("Failed to get zig temporary file directory");
        return "";
    }
}
